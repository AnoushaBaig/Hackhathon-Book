...
const config: Config = {
  ...
  url: 'https://AnoushaBaig.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/Hackhathon-Book/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'AnoushaBaig', // Your GitHub username (case sensitive)
  projectName: 'Hackhathon-Book',  // Your repo name (case sensitive)
